...
export default function FileTags() {
  const [tags, setTags] = useState<FileTag[]>(() => {
    const savedTags = localStorage.getItem('file_tags');
  ...
  useEffect(() => {
    localStorage.setItem('file_tags', JSON.stringify(tags));
  }, [tags]);
  ...
  const handleEditClick = (tag: FileTag) => {
